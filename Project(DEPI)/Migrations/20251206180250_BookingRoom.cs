    ...
    public partial class BookingRoom : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_Roles", x => new { x.UserProfileId, x.RoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserProfileId = table.Column<int>(type: "int", nullable: false),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    PricePreview = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationCarts", x => x.ReservationCartId);
                    table.ForeignKey(
                        name: "FK_ReservationCarts_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "RoomId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationCarts_Rooms_RoomId1",
                        column: x => x.RoomId1,
                        principalTable: "Rooms",
                        principalColumn: "RoomId");
                    table.ForeignKey(
                        name: "FK_ReservationCarts_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionRefrence = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BookingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationCarts_RoomId",
                table: "ReservationCarts",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationCarts_RoomId1",
                table: "ReservationCarts",
                column: "RoomId1");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationCarts_UserProfileId",
                table: "ReservationCarts",
                column: "UserProfileId");
